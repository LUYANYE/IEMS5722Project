...
//取回聊天室数据
public class FetchChatroomnameTask extends AsyncTask<Void,Integer,String> {
    ...
    public FetchChatroomnameTask(Context context , String url ,ArrayList<Chatroom> ChatroomList,ChatroomAdapter adapter){
